...
[![Build Status](https://travis-ci.org/bcoe/saml2tu.png)](https://travis-ci.org/bcoe/saml2tu)

`saml2tu` is a fork of [saml2-js](https://github.com/Clever/saml2), adding fixes
for additional IDP providers.

`saml2tu` is a node module that abstracts away the complexities of the SAML protocol behind an easy to use interface.
...
```bash
  npm install saml2tu --save
```

Include the SAML library.

```javascript
  var saml2 = require('saml2tu');
```
